...
const { get_details_patient, book_appointment, pay_invoice } = require("../../controllers/patient");
...
route.get("/getPatientSymptoms/:id",[requireAuth("doctor")],get_patient_symptoms)
