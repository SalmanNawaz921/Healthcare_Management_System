...
var doctorAttributes = function doctorAttributes(params) {
  return [{
    name: "qualification",
    type: sql.VarChar,
...
var hospitalAttributes = function hospitalAttributes(params) {
  return [{
    name: "adminID",
    type: sql.Int,
...
var departmentAttributes = function departmentAttributes(params) {
  return [{
    name: "hospitalID",
    type: sql.Int,
...
var medicinesAttributes = function medicinesAttributes(params) {
  return [{
    name: "name",
    type: sql.VarChar,
    value: params.Name,
...
var prescriptionAttributes = function prescriptionAttributes(params) {
  return [{
    name: "symptomID",
    type: sql.Int,
...
var treatmentAttributes = function treatmentAttributes(params) {
  return [{
    name: "name",
    type: sql.VarChar,
    value: params.Name,
...
var invoiceAttributes = function invoiceAttributes(params) {
  return [{
    name: "prescriptionID",
    type: sql.Int,
...
var appointmentAttributes = function appointmentAttributes(params) {
  return [{
    name: "doctorId",
    type: sql.Int,
...
var personAttributes = function personAttributes(params, userID) {
  return [{
    name: "firstname",
    type: sql.NVarChar,
...
module.exports = {
  ...
  hospitalAttributes: hospitalAttributes,
  departmentAttributes: departmentAttributes,
  treatmentAttributes: treatmentAttributes,
  medicinesAttributes: medicinesAttributes,
  prescriptionAttributes: prescriptionAttributes,
