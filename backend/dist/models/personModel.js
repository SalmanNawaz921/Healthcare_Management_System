...
var _require3 = require("../constants/constants"),
  personAttributes = _require3.personAttributes;
var Person = {
  ...
  insertPerson: function insertPerson(userid, firstname, lastname, email, dateofbirth, gender, transaction) {
    var _this = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            query = "INSERT INTO Person (UserID,FirstName, LastName, Email, DateOfBirth,Gender) VALUES (@userid,@firstname, @lastname, @email, @dateofbirth,@gender);";
            parameters = [{
              name: "firstname",
              type: sql.NVarChar,
              value: firstname
          ...
          case 5:
            _context3.next = 7;
            return _this.findById(userid, transaction);
          case 7:
  ...
  updatePerson: function updatePerson(UserID, params) {
    var _this2 = this;
